...
# the value for variables (which were defined in common.sh) component, schema_setup and app_path are defined in the files wherever they are needed for execution.
